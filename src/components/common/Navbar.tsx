...
function Navbar() {
  ...
  return (
    <nav className="w-full bg-csc-maroon-bg py-6 fixed top-0 left-0 z-50">
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <ul className="flex flex-col items-center space-y-4 mt-4 pb-6 md:hidden text-neutral-50 text-xl font-semibold tracking-wider bg-csc-maroon-bg">
          ...
          <li><Link to="/sponsorships" onClick={closeMenu} className="hover:text-gray-300 transition">Sponsorships</Link></li>
